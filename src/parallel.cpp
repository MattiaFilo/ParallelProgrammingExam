...
*/
void kMeansParallel(MultiDimPoint* points, int& n_points, int& n_clusters, int max_iters, unsigned int in_seed, int& points_dimensions, string output_name) {
    // Init clusters
...
void kMeansParallel(Dataset* dataset, int& n_points, int& n_clusters, int max_iters, unsigned int in_seed, string output_name) {
    ...
    kMeansParallel(points, n_points, n_clusters, max_iters, in_seed, dataset->points_dimensions, output_name);
}